...
`notes/themes/USER_PREFERENCES.md` に蓄積した観測から、repo-wide で durable な user preference だけを `AGENTS.md` へ昇格します。
...
1. `notes/themes/USER_PREFERENCES.md` を読み、重複、反復、明示的な durable preference を cluster します。
