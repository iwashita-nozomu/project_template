...
とくに、`scheduler`、`schedule_reviewer`、`designer`、`design_reviewer`、`document_flow_reviewer` は repo-changing task の標準構成とします。調査が必要なら `researcher` と `research_reviewer` も明示的に有効化します。
