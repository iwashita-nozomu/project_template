...
base profile は Python 実装と Markdown 文書を想定しますが、Docker、C++、実験、GitHub/Copilot、multi-runtime mirror、memory は opt-in profile です。
...
- GitHub automation: `.github/`、Actions、PR templates、Copilot。
...
- agent を使う場合は `agents/README.md` と `agents/workflows/README.md`
...
1. 変更前に必要な baseline を決めます。小さい docs 修正なら status と docs check、Python 変更なら targeted pytest / pyright / ruff、shared canon 変更なら AgentCanon PR gate を選びます。
