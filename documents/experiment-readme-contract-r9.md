...
| `vendor/agent-canon/templates/documents/experiment/README.template.md` | Fixed plan headings | convert | r9 contract | One-heading/thin scaffold fails; reordered complete passes. |
| `vendor/agent-canon/templates/agents/experiment_report.md` | Fixed report order | convert | Report-writing plus r9 mode | Reader-specific order remains free. |
