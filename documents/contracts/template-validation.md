...
- `make runtime-independence-check` validates the exact registered AgentCanon submodule and rejects any additional gitlink, producer-runtime projection, updater/dispatcher reference, parent-owned `tests/agent_tools` namespace, or non-regular seed file.
